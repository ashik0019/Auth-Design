...
const Login = () => {
    return (
        <View style={{ flex: 100, alignItems: 'center' }}>
                ...
                <ImageBackground style={{ width: '100%', height: '100%' }} source={require('./assets/background.png')}>
                    <View style={{ backgroundColor: '#2699FB', flex: 50, opacity: 0.9 }}>
                        <View style={{ flex: 38, alignItems: 'center' }}>
                            ...
                            <View style={{ flex: 8, }}>
                                <Text style={{ color: 'white', fontSize: 16, paddingTop: 7 }}>Login</Text>
                            </View>
                        </View>
            ...
            <View style={{ width: '80%', height: '68%', backgroundColor: 'white', marginTop: '40%', elevation: 10, borderRadius: 2 }}>
                <View style={{ marginTop: '23%', marginHorizontal: 30 }}>
                    ...
                    <View style={{ marginTop: 20 }}>
                        <Text style={{ fontSize: 16, textAlign: 'center', color: '#C8C8C8' }}>Create New Account</Text>
                        <Text style={{ fontSize: 16, textAlign: 'center', color: '#C8C8C8' }}>Forget Password</Text>
                    </View>
                </View>
            </View>
        </View>
